...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--grounded_checkpoint", type=str, default="/home/appusr/semantic_pointcloud_ws/src/grounded_sam/script/groundingdino_swint_ogc.pth", help="path to checkpoint file"
    )
    parser.add_argument(
        "--sam_checkpoint", type=str, default="/home/appusr/semantic_pointcloud_ws/src/grounded_sam/script/sam_vit_h_4b8939.pth", help="path to sam checkpoint file"
    )
    parser.add_argument(
    ...
    parser.add_argument("--input_image", type=str, default="/home/appusr/semantic_pointcloud_ws/src/grounded_sam/script/assets/demo1.jpg", help="path to image file")
    parser.add_argument("--text_prompt", type=str, default="bear", help="text prompt")
    parser.add_argument(
        "--output_dir", "-o", type=str, default="/home/appusr/semantic_pointcloud_ws/src/grounded_sam/script/output", help="output directory"
    )
